...
const Harvest: React.FC = () => {
  const tombStats = useStats('LUNAR');
  const { onReward } = useClaimRewardFromSunrise('LUNAR');
  const earnings = useEarningsOnSunrise('LUNAR');
  ...
  const { from, to } = useClaimRewardTimerSunrise('LUNAR');

...
import useWithdrawCheckLunarSunrise from '../../../hooks/masonry/useWithdrawCheckTripolarSunrise';
...
import useStakedBalanceOnMasonry from '../../../hooks/useStakedBalanceOnTripolarSunrise';
import useStakedTokenPriceInDollars from '../../../hooks/useStakedTokenPriceInDollars';
import useUnstakeTimerMasonry from '../../../hooks/masonry/useUnstakeTimerTripolarSunrise';
...
const Stake: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(polarisFinance.TSHARE, polarisFinance.contracts.tripolarSunrise.address);

  const tokenBalance = useTokenBalance(polarisFinance.TSHARE);
  const stakedBalance = useStakedBalanceOnMasonry();
  const { from, to } = useUnstakeTimerMasonry();

  const stakedTokenPriceInDollars = useStakedTokenPriceInDollars('SPOLAR', polarisFinance.TSHARE);

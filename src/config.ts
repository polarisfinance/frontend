...
const configurations: { [env: string]: Configuration } = {
  production: {
    ...
    externalTokens: {
      ...
      'ETH-NEAR-LP': ['0x63da4DB6Ef4e7C62168aB03982399F9588fCd198', 18],
      ETHERNAL: ['0x5DbE9348FE9571106174ffdA6122aba5622b954C', 18],
      EBOND: ['0x8e1fFEE5AE5b0F6F23646Bb6E769457e8775D7aD', 18],
      'ETHERNAL-ETH-LP': ['0xb678873C286eDE3d2f14358494d074880FE3897C', 18],
    },
...
export const sunriseDefinitions: { [contractName: string]: SunriseInfo } = {
  ...
  EthernalSunrise: {
    ...
    retired: false,
    bond: 'EBOND',
    tokenAddress: '0x1Fb32B3F51ff91Aa0aE78531D1d884220cd87622',
    lpAddress: '0xb678873C286eDE3d2f14358494d074880FE3897C',

...
const configurations: { [env: string]: Configuration } = {
  production: {
    ...
    externalTokens: {
      ...
      USP: ['0x127C31CDbb8041f11AeF63d3602fc745fAd2E195', 18],
      'USP-USDC-LP': ['0x49BB54e9fAC7F900619b07d1D155e4321C594122', 18],
...
export const sunriseDefinitions: { [contractName: string]: SunriseInfo } = {
  ...
  UspSunrise: {
    ...
    notActive: false,
    bond: 'USPBOND',
    tokenAddress: '0x127C31CDbb8041f11AeF63d3602fc745fAd2E195',
    lpAddress: '0x49BB54e9fAC7F900619b07d1D155e4321C594122',

...
const configurations: { [env: string]: Configuration } = {
  production: {
    ...
    defaultWssProvider: 'http://localhost:8545',
    ...
    externalTokens: {
      ...
      USP: ['0xeb1180C45b37728e9b14B81a84E8131cD5A41Eb2', 18],
      'USP-USDC-LP': ['0x41Dabc6DB68aC99025ABFCC7223eA3E16f11B1E2', 18],
...
export const sunriseDefinitions: { [contractName: string]: SunriseInfo } = {
  ...
  UspSunrise: {
    ...
    notActive: false,
    bond: 'USPBOND',
    tokenAddress: '0xeb1180C45b37728e9b14B81a84E8131cD5A41Eb2',
    lpAddress: '0x41Dabc6DB68aC99025ABFCC7223eA3E16f11B1E2',
